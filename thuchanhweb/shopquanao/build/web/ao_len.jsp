...
<head>
  ...
  <style>
    ...
    *{font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif}
    ...
    /* Product card */
    .card-product{background:#fff;border:1px solid #eee;border-radius:16px;overflow:hidden;position:relative;transition:transform .2s, box-shadow .2s}
    .card-product:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,.08)}
    ...
    .card-product:hover .quickbar{bottom:0}
...
<!--  <header class="atino-header">
  ...
  <div class="container py-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-2">
        ...
        <li class="breadcrumb-item active" aria-current="page">Áo Len</li>
      </ol>
    </nav>
    <h1 class="h3 fw-bold">Áo Len</h1>
  </div>
    ...
    <div class="row g-4">
      ...
      <c:forEach items="${products}" var="p" varStatus="st">
        <div class="col-12 col-md-6 col-xl-3">
          <div class="card-product h-100">
            ...
            <div class="p-3">
              <div class="small text-muted text-center">Atino</div>
              <div class="fw-semibold text-center text-truncate" title="${p.name}">${p.name}</div>
            ...
            <div class="quickbar">
              <form action="cart" method="post" class="m-0">
                ...
                <button class="btn btn-light btn-sm" ${!p.inStock?"disabled":''}>Mua nhanh</button>
              </form>
      ...
      <c:if test="${empty products}">
        <c:forEach begin="1" end="8" var="i">
          <div class="col-12 col-md-6 col-xl-3">
            <div class="card-product h-100">
              <c:if test="${i==3}"><span class="badge-oos">Hết hàng</span></c:if>
              <img class="product-img w-100" src="https://images.unsplash.com/photo-1503342217505-b0a15cf70489?q=80&w=640&auto=format&fit=crop" alt="Demo" />
              <div class="p-3 text-center">
                <div class="small text-muted">Atino</div>
                <div class="fw-semibold">Áo Len XL.5${i}45</div>
                <div class="my-2">
                  <span class="color-dot" style="background:#2e2e2e"></span>
                  <span class="color-dot" style="background:#8b7355"></span>
                  <span class="color-dot" style="background:#d9d9d9"></span>
                </div>
                <div class="price"><fmt:formatNumber value="${179000 + i*20000}" type="currency" currencySymbol="" maxFractionDigits="0"/>₫</div>
              </div>
              <div class="quickbar">
                <button class="btn btn-light btn-sm" ${i==3?"disabled":''}>Mua nhanh</button>
  ...
  <!-- Large banner before footer -->
  <div class="container my-4">
    <img class="w-100 rounded-3" src="https://images.unsplash.com/photo-1603574670812-d24560880210?q=80&w=1600&auto=format&fit=crop" alt="Store banner" />
  </div>
  ...
  <footer class="footer py-5 mt-5">
    <div class="container">
      ...
      <div class="text-center text-muted small mt-4">© <script>document.write(new Date().getFullYear())</script> Atino – Trang Áo Len (JSP)</div>
    </div>
  </footer>
