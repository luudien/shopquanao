...
<head>
  ...
  <style>
    ...
    *{font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif}
    ...
    /* Layout giống ảnh: cột lớn hơn, 2–4 cột tùy màn hình */
    @media (min-width: 1200px){.col-xl-5th{flex:0 0 40%;max-width:40%}}
...
<!--  <header class="atino-header">
  ...
  <div class="container py-3">
    ...
    <h1 class="h3 fw-bold">Cardigan</h1>
  </div>
  ...
  <!-- Product Grid (Cardigan thường ít mẫu – bố cục 2/3 cột) -->
  <div class="container py-3">
    <div class="row g-4 justify-content-start">
      <!-- products: List<Product> {id,name,price,oldPrice,imageUrl,colors} -->
      <c:forEach items="${products}" var="p">
        <div class="col-12 col-md-6 col-xl-5th">
          <a href="detail?id=${p.id}" class="text-decoration-none text-dark">
            <div class="product-card h-100">
              ...
              <div class="p-3 text-center">
                <div class="brand">Atino CARDIGAN | ${p.sku}</div>
      ...
      <c:if test="${empty products}">
        <c:forEach begin="1" end="2" var="i">
          <div class="col-12 col-md-6 col-xl-5th">
            <div class="product-card h-100">
              <img class="product-img w-100" src="https://images.unsplash.com/photo-1520975922215-230fnone7b8b?q=80&w=900&auto=format&fit=crop" alt="Demo" />
              <div class="p-3 text-center">
                <div class="brand">Atino CARDIGAN | 53${i}</div>
                <div class="fw-semibold">Áo Cardigan Regular L3.52${i}6</div>
                <div class="my-2">
  ...
  <footer class="footer py-5 mt-5">
    <div class="container">
      ...
      <div class="text-center text-muted small mt-4">© <script>document.write(new Date().getFullYear())</script> Atino – Trang Cardigan (JSP)</div>
    </div>
  </footer>
