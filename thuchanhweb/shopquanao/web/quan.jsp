...
<!--  <header class="atino-header">
  ...
  <div class="container py-3">
    <div class="row g-4">
      <!-- products: List<Product> {id, sku, name, price, oldPrice, imageUrl, colors, inStock} -->
        ...
        <div class="col-12 col-md-6 col-xl-3">
          <div class="product-card h-100">
            ...
            <div class="p-3 text-center">
              <div class="brand">ATINO TROUSERS | ${p.sku}</div>
      ...
      <!-- Fallback demo when products empty -->
        ...
        <c:forEach begin="1" end="4" var="i">
          <div class="col-12 col-md-6 col-xl-3">
            <div class="product-card h-100">
              ...
              <div class="p-3 text-center">
                <div class="brand">ATINO TROUSERS | 3${i}07</div>
                <div class="fw-semibold">Quần Nỉ Loose L3.18${40+i}</div>
                <div class="my-2">
                  <span class="color-dot" style="background:#d1d5db"></span>
                </div>
                <div class="price"><fmt:formatNumber value="${99000 + i*30000}" type="currency" currencySymbol="" maxFractionDigits="0"/>₫</div>
              </div>
              <div class="quickbar">
  ...
  <div class="container my-4">
    <img class="w-100 rounded-3" src="https://images.unsplash.com/photo-1625999402882-bbfe5e6099f3?q=80&w=1600&auto=format&fit=crop" alt="Pants banner" />
  </div>
  ...
  <footer class="footer py-5 mt-5">
    <div class="container">
      ...
      <div class="text-center text-muted small mt-4">© <script>document.write(new Date().getFullYear())</script> Atino – Trang Quần (JSP)</div>
    </div>
  </footer>
